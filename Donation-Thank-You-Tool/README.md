...
walkthrough. (No link? Open `how-it-works.html` in this folder.)

> **Two guides — pick one:**
> - **[GUIDE.md](GUIDE.md)** — the normal walkthrough. Assumes you already know
>   how to install a program using a folder set up similar to this.
> - **[GUIDE-SIMPLE.md](GUIDE-SIMPLE.md)** — for non-tech savvy people.
>
> Both end in the same place. The quick start below is the short version.
